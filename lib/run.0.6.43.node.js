...
function _activeKernel () {
  const Kernel = __webpack_require__(30)
...
class CodeDeps {
  ...
  static get _sync () { return __webpack_require__(50) }
...
const DeterministicRealm = __webpack_require__(46)
...
function _owner (owner, allowNull = false, bsvNetwork = undefined) {
  const CommonLock = __webpack_require__(41)
  ...
  const { Lock } = __webpack_require__(51)
...
const { _unifyForMethod } = __webpack_require__(31)
const Dynamic = __webpack_require__(47)
const Log = __webpack_require__(2)
...
function upgradeCode (C, T, local = true, src = undefined) {
  ...
  const Snapshot = __webpack_require__(34)
...
class Record {
  ...
  _commit () {
    ...
    const Commit = __webpack_require__(35)
...
async function _sha256 (data) {
  const sha256 = __webpack_require__(30)._sha256
...
const { _extractMetadata } = __webpack_require__(32)
...
async function _loadBerryFromLocation (location, kernel, session, timeout) {
  const loadFunction = async () => {
    ...
    if (state) {
      ...
      const _recreate = __webpack_require__(42)
...
async function _loadJigViaReplay (location, kernel, session, timeout) {
  ...
  if (session._replays.has(txid)) {
    ...
    try {
      ...
      const _replay = __webpack_require__(33)
...
async function _pluckBerry (path, hash, version, B, kernel, session, timeout) {
  ...
  try {
    ...
    if (berryClassDeployed) {
      ...
      const { _captureBerry } = __webpack_require__(49)
...
if (true) {
  requestInternal = async function (url, method, body, timeout, headers) {
    return new Promise((resolve, reject) => {
      const https = url.startsWith('http://') ? __webpack_require__(61) : __webpack_require__(62)
...
const { _sudo } = __webpack_require__(4)
const SerialTaskQueue = __webpack_require__(48)
...
async function captureStates (commit, timeout) {
  ...
  const { _captureJig } = __webpack_require__(49)
...
// Kernel
const Kernel = __webpack_require__(30)
const { Blockchain, Cache, Lock, Logger, Owner, Purse, State } = __webpack_require__(51)
const Jig = __webpack_require__(7)
const Berry = __webpack_require__(13)
const Code = __webpack_require__(1)
const Editor = __webpack_require__(9)
...
const { _browser, _nodejs } = __webpack_require__(40)
const request = __webpack_require__(18)
const { ArgumentError } = __webpack_require__(11)
const { _extractMetadata, _extractTxDeps } = __webpack_require__(32)

// Plugins
const BrowserCache = __webpack_require__(64)
const DiskCache = __webpack_require__(52)
const IndexedDbCache = __webpack_require__(67)
const Inventory = __webpack_require__(68)
const LocalCache = __webpack_require__(37)
const LocalOwner = __webpack_require__(53)
...
const RunConnect = __webpack_require__(56)
...
// Wrappers
const BlockchainWrapper = __webpack_require__(39)
const CacheWrapper = __webpack_require__(36)
const OwnerWrapper = __webpack_require__(43)
const PurseWrapper = __webpack_require__(45)
const StateWrapper = __webpack_require__(38)
...
// Extra
Run.extra = __webpack_require__(44)
...
Run._DeterministicRealm = __webpack_require__(46)
Run._Dynamic = __webpack_require__(47)
Run._EDITORS = __webpack_require__(9)._EDITORS
Run._environment = __webpack_require__(40)
...
Run._RecentBroadcasts = __webpack_require__(55)
...
Run._SerialTaskQueue = __webpack_require__(48)
Run._sighash = __webpack_require__(12)._sighash
Run._Snapshot = __webpack_require__(34)
...
Run.util.recreateJigsFromStates = __webpack_require__(54)
...
const _load = __webpack_require__(16)
const Record = __webpack_require__(10)
const { _unifyForReplay, _deunifyForReplay, _setUnifyForMethodEnabled } = __webpack_require__(31)
const { _sudo } = __webpack_require__(4)
const Json = __webpack_require__(23)
const Sandbox = __webpack_require__(6)
const {
...
async function _replay (tx, txid, metadata, kernel, published, jigToSync, timeout, preverify) {
  const _execute = __webpack_require__(60)
...
const bsv = __webpack_require__(5)
const RecentBroadcasts = __webpack_require__(55)
const Log = __webpack_require__(2)
const LocalCache = __webpack_require__(37)
...
const recreateJigsFromStates = __webpack_require__(54)
...
const ses = __webpack_require__(58)
...
class DeterministicRealm {
  constructor () {
    ...
    if (false) {} else {
      const vm = __webpack_require__(59)
...
if (true) {
  const CacheWrapper = __webpack_require__(36)
  const { _sha256 } = __webpack_require__(30)
...
class LocalOwner extends OwnerWrapper {
  ...
  constructor (privkey, network = undefined) {
    ...
    network = network || (__webpack_require__(29).instance && __webpack_require__(29).instance.blockchain.network)
  ...
  async sign (rawtx, parents, locks) {
    const CommonLock = __webpack_require__(41)
    const MainnetGroup = __webpack_require__(44).main.Group
    const TestnetGroup = __webpack_require__(44).test.Group
...
// Environment checks
__webpack_require__(40)._check()

const bsv = __webpack_require__(5)
const Run = __webpack_require__(29)
